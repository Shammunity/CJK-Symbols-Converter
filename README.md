# CJK Symbols Converter for Roam Research

Automatically pair the following CJK(Chinese only) brackets and quotation marks entered when the CJK input methods are activated.
